...
function Heading({
  ...
  return (
    <div className="relative bg-white w-fit rounded-lg text-black  border-inherit ">
      ...
      <div
        className={`font-bold text-xl bg-white/85 backdrop-blur-sm p-2 rounded-lg border-inherit border -translate-x-1 -translate-y-1 hover:translate-x-0 hover:translate-y-0  w-fit ${className} `}
      >
        {children}
      </div>
    </div>
